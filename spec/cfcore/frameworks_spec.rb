...
describe 'core frameworks', :cfcore => true, :mcf => true do
  ...
  it { should have_framework :node, 'node', '0.4' }
  it { should have_framework :node, 'node06', '0.6' }
  it { should have_framework :node, 'node08', '0.8' }
  ...
  it { should have_framework :standalone, 'ruby19', '1.9.2' }
  it { should have_framework :standalone, 'node', '0.4' }
  it { should have_framework :standalone, 'node06', '0.6' }
  it { should have_framework :standalone, 'node08', '0.8' }
