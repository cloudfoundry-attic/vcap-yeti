...
describe 'core frameworks', :cfcore => true, :mcf => true do
  ...
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :standalone, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :standalone, 'java7', '1.7'
    end
  }
  ...
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :lift, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :lift, 'java7', '1.7'
    end
  }

  it {
    pending 'Java runtimes returning strings' do
      should have_framework :java_web, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :java_web, 'java7', '1.7'
    end
  }

  it {
    pending 'Java runtimes returning strings' do
      should have_framework :spring, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :spring, 'java7', '1.7'
    end
  }

  it {
    pending 'Java runtimes returning strings' do
      should have_framework :grails, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :grails, 'java7', '1.7'
    end
  }
  ...
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :play, 'java', '1.6'
    end
  }
  it {
    pending 'Java runtimes returning strings' do
      should have_framework :play, 'java7', '1.7'
    end
  }
