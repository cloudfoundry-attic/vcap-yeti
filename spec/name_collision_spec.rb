...
describe "Application name collision" do
  ...
  it "will not push two apps with the same name" do
    create_app("standalone_simple_ruby_app").push
    expect {
      create_app("standalone_simple_ruby_app").push
    }.to raise_error
  end

    #it "will not push two apps with the same URL"
  #it "will be case insensitive when not pushing two apps with the same name"
  #it "will be case insensitive when not pushing two apps with the same URL"
